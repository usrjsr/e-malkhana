    ...
    <div className="min-h-screen bg-linear-to-br from-gray-50 to-blue-50 px-4 py-8">
      <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
        <div>
          ...
          <p className="text-gray-600">{caseData.policeStationName}</p>
          <span
      ...
      <div className="mb-8 bg-white border-2 border-gray-300 p-6 rounded-xl shadow-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <p className="text-lg font-bold">{caseData.investigatingOfficer.name}</p>
          </div>

          <div>
            <p className="text-sm font-semibold text-gray-600">Officer ID</p>
            <p className="text-lg font-bold">{caseData.investigatingOfficer.officerId}</p>
          </div>
          ...
          <div>
            ...
            <p className="text-lg font-bold">
              {caseData.dateOfFIR
                ? new Date(caseData.dateOfFIR).toLocaleDateString("en-IN")
                : "N/A"}
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-lg font-bold">
              {caseData.dateOfSeizure
                ? new Date(caseData.dateOfSeizure).toLocaleDateString("en-IN")
                : "N/A"}
            </p>
          </div>
        </div>
            ...
            <div key={p._id} className="p-6 border-t">
              <div className="flex flex-col lg:flex-row gap-6">
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-600">{p.nature} | {p.location}</p>
