      ...
      <div class="section">
        ...
        <div class="detail-grid">
          <div class="detail-item">
            <div class="detail-label">Crime Number</div>
            <div class="detail-value">${caseData.crimeNumber}</div>
          </div>
          <div class="detail-item">
            <div class="detail-label">Crime Year</div>
            <div class="detail-value">${caseData.crimeYear}</div>
          </div>
          <div class="detail-item">
            <div class="detail-label">Police Station</div>
            <div class="detail-value">${caseData.policeStationName}</div>
          </div>
          <div class="detail-item">
