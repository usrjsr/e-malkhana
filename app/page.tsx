        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">
              A secure platform for managing seized property and evidence in police custody
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            ...
            <div className="bg-[#f8f9fa] border-2 border-[#1e3a8a] p-6 text-center">
              ...
              <h3 className="font-bold text-[#1e3a8a] mb-2">Chain of Custody</h3>
              <p className="text-sm text-gray-600">
          ...
          <div className="mt-12 bg-[#fff3cd] border-l-4 border-[#ffc107] p-4">
            <div className="flex items-start">
              ...
              <div>
                <h4 className="font-bold text-[#856404] mb-1">Important Notice</h4>
                <p className="text-sm text-[#856404]">
                  This system is for authorized police personnel only. Unauthorized access is strictly prohibited
                  and will be prosecuted under applicable laws. All activities are logged and monitored.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-6">
            <div>
              ...
              <p className="text-sm text-blue-200">
                A digital initiative to modernize evidence management in police stations across India.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-sm text-blue-200">
                ...
                Email: support@emalkhana.gov.in<br />
